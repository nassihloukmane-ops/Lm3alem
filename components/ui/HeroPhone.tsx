...
export function HeroPhone() {
  return (
    ...
    >
      ...
      >
        {/* Phone frame */}
        <div className="relative rounded-[2.5rem] border-[6px] border-teal bg-teal p-2 shadow-2xl">
          {/* Notch */}
          <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10 h-6 w-24 rounded-full bg-teal-dark" />

          {/* Screen */}
          <div className="relative overflow-hidden rounded-[2rem] aspect-[9/19]">
            <div className="absolute inset-0 bg-gradient-to-br from-saffron via-saffron-light to-terracotta" />
            ...
            <div className="relative z-10 flex flex-col h-full p-4 pt-10">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <div className={`w-1.5 h-1.5 rounded-full ml-auto mt-0.5 ${artisan.avail ? "bg-emerald-400" : "bg-gray-400"}`} />
                    </div>
                  </div>
                ))}
              </div>
              ...
              {/* Bottom nav */}
              <div className="mt-2 flex justify-around bg-white/15 backdrop-blur rounded-2xl py-2">
                {["🏠", "🔍", "💬", "👤"].map((icon, i) => (
        ...
        {/* Decorative elements */}
        <div className="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-saffron/20 blur-2xl" />
        <div className="absolute -bottom-6 -left-6 w-24 h-24 rounded-full bg-teal/15 blur-2xl" />
      </motion.div>
    </motion.div>
  );
}
